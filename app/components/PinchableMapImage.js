...
export default class PinchableMapImage extends React.Component {
	...
	onLayout = async (event) => {
		...
		console.log('onLayout. wrapperWidth:', this.state.wrapperWidth, 'wrapperHeight:', this.state.wrapperHeight)
	}
  							...
  							<Animated.View style = {[
  								...
  								>
  									...
  									<View 
  										style = {{
  											position: 'absolute',
  											opacity: this.props.showOverlay ? 0.8 : 0,
  											transform:
  											[
  												{ translateX: this.state.wrapperWidth * this.props.xPercent },
  												{ translateY: this.state.wrapperHeight * this.props.yPercent },	
  											]
  										}}
  									>
  										<Icon
