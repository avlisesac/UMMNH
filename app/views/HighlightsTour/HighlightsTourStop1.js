	...
	render(){
		return(
			<StopScreen
				...
				shortDescription = { 'These two mastodons <i>lived at the end of the last ice age. The smaller</i> skeleton is a female that was discovered in Owosso, Michigan in 1944. The larger one is a male that was found in 1998 near Fort Wayne, Indiana.' }
